...
Scope: JS/TS
Rule: Always use direct named exports with export keyword. Avoid default exports.
...
Rule: Use import.meta.dirname over dirname(fromFileUrl(import.meta.url))
...
Rule: Use import.meta for module paths, cwd() for user context
...
Rule: Add optional projectRoot?: string parameter. Enables testing without global state changes.
...
Rule: Use globalThis instead of window. Works across all runtimes.
...
Scope: JS/TS
Rule: Use slice() instead of substring() or substr(). substr() deprecated.
